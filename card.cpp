...
Card::Card(short p_cost, short p_arrayPosition, short p_health, short p_damage, int p_id)
...
/* { */
	...
	/* /1* SDL_DestroyTexture(costTexture); *1/ */
...
void Card::damaged(short p_damageTaken)
{
